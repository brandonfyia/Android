	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//HTTP Service Intent
				Intent getHTTPIntent = new Intent(_context, WebServiceManager.class);
				getHTTPIntent.putExtra(WebServiceManager.MESSENGER_KEY, HTTPMessenger);
				getHTTPIntent.putExtra(WebServiceManager.MOVIE_KEY, _searchField.getText().toString());
				//Start service
