	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		searchButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//HTTP Service Intent
				Intent getHTTPIntent = new Intent(_context, HTTPService.class);
				getHTTPIntent.putExtra(HTTPService.MESSENGER_KEY, HTTPMessenger);
				getHTTPIntent.putExtra(HTTPService.MOVIE_KEY, _searchField.getText().toString());
				//Start service
